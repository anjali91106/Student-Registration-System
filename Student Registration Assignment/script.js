...
function saveRow(button) {
  ...
  let updatedStudent = {
    firstName: cells[0]?.querySelector("input") ? cells[0].querySelector("input").value : cells[0].innerText,
    lastName: cells[1]?.querySelector("input") ? cells[1].querySelector("input").value : cells[1].innerText,
    email: cells[2]?.querySelector("input") ? cells[2].querySelector("input").value : cells[2].innerText,
    id: cells[3]?.querySelector("input") ? cells[3].querySelector("input").value : cells[3].innerText,
    contact: cells[4]?.querySelector("input") ? cells[4].querySelector("input").value : cells[4].innerText
  };
